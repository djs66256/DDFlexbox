#
#  Be sure to run `pod spec lint DDFlexbox.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.homepage     = "https://github.com/djs66256/DDFlexbox"
  ...
  spec.subspec "Objc" do |s|
    ...
    s.source_files  = "Classes", "Classes/objc/**/*.{h,m,mm}"
