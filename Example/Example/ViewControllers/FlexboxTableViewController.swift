...
class FlexboxTableViewController : UITableViewController {
    var cellClasses: [UITableViewCell.Type] = []
    ...
    override func viewDidLoad() {
        ...
        cellClasses = [DDTableLikeCell.self, DDChatTableViewCell.self, DDNewsWithImageCell.self, DDPushStyleTableCell.self]
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: String(reflecting: cellClasses[indexPath.row]))!
